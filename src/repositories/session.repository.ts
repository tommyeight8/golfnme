...
import type { GroupSession, SessionMember, SessionStatus, Course, User, Round } from '@prisma/client'
...
export class SessionRepository {
  ...
  async findByInviteCode(inviteCode: string): Promise<SessionWithDetails | null> {
    return prisma.groupSession.findUnique({
  ...
  async addMember(sessionId: string, userId: string): Promise<SessionMemberWithUser> {
  ...
  async setMemberReady(sessionId: string, userId: string, isReady: boolean): Promise<SessionMember> {
