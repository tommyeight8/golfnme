...
export default function LoginPage() {
  ...
  const [authError, setAuthError] = useState(error ? 'Invalid credentials' : '')
  ...
  return (
    <div className="min-h-screen bg-sand-50 flex flex-col">
      ...
      <header className="p-6">
        <Link href="/" className="inline-flex items-center gap-2 text-fairway-700 hover:text-fairway-800">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-sand-900 mb-2">Welcome back</h1>
            <p className="text-sand-600">Sign in to track your golf game</p>
          </div>
          ...
          <div className="card p-8">
            ...
            >
              ...
              <span className="font-medium text-sand-700">Continue with Google</span>
            </button>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-sand-500">or continue with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded border-sand-300 text-fairway-600 focus:ring-fairway-500" />
                  <span className="text-sand-600">Remember me</span>
                </label>
                <Link href="/forgot-password" className="text-fairway-600 hover:text-fairway-700 font-medium">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center mt-6 text-sand-600">
            ...
            <Link href="/signup" className="text-fairway-600 hover:text-fairway-700 font-medium">
              Sign up free
            </Link>
          </p>
        </motion.div>
