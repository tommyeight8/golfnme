      ...
      <main className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-sand-900 mb-2">Create your account</h1>
            <p className="text-sand-600">Start tracking your golf journey today</p>
          </div>
          ...
          <div className="card p-8">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-sand-500">or create with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-sand-500 text-center">
                ...
                <Link href="/terms" className="text-fairway-600 hover:underline">Terms</Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-fairway-600 hover:underline">Privacy Policy</Link>
              </p>
            </form>
          </div>
          ...
          <p className="text-center mt-6 text-sand-600">
            ...
            <Link href="/login" className="text-fairway-600 hover:text-fairway-700 font-medium">
              Sign in
            </Link>
          </p>
        </motion.div>
