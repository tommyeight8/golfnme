      ...
      <header className="bg-white border-b border-sand-200">
        <div className="max-w-3xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-sand-900">Settings</h1>
          </div>
        </div>
      </header>
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between p-4 bg-sand-50 rounded-xl cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sand-900">Dark Mode</p>
                  <p className="text-sm text-sand-500">Use dark theme</p>
                </div>
              </div>
              <input
                type="checkbox"
                ...
                className="w-5 h-5 rounded border-sand-300 text-fairway-600 focus:ring-fairway-500"
              />
            </label>
            ...
            <label className="flex items-center justify-between p-4 bg-sand-50 rounded-xl cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sand-900">Push Notifications</p>
                  <p className="text-sm text-sand-500">Get notified about game invites</p>
                </div>
              </div>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between p-4 bg-sand-50 rounded-xl cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sand-900">Email Updates</p>
                  <p className="text-sm text-sand-500">Receive weekly stats summary</p>
                </div>
              </div>
              <input
                type="checkbox"
        ...
        >
          ...
          <div className="space-y-4">
            <button className="w-full flex items-center justify-between p-4 bg-sand-50 rounded-xl hover:bg-sand-100 transition-colors text-left">
              <div>
                <p className="font-medium text-sand-900">Change Password</p>
                <p className="text-sm text-sand-500">Update your password</p>
              </div>
            ...
            <button className="w-full flex items-center justify-between p-4 bg-sand-50 rounded-xl hover:bg-sand-100 transition-colors text-left">
              <div>
                <p className="font-medium text-sand-900">Download My Data</p>
                <p className="text-sm text-sand-500">Export all your golf data</p>
              </div>
              <ArrowLeft className="w-5 h-5 text-sand-400 rotate-180" />
            </button>
          </div>
